                     ...
                     <div class="row">
                        <div class="col-lg-6 col-md-12">
                           <div class="hedingh3 text_align_left">
                              ...
                              <a href="<?=base_url('beranda');?>" class="nav-item nav-link active">Beranda</a>
                <a href="<?=base_url('tentangkami');?>" class="nav-item nav-link">Tentang kami</a>
                <a href="<?=base_url('servis');?>" class="nav-item nav-link">Servis</a>
                <a href="p<?=base_url('produk');?>" class="nav-item nav-link">Produk</a>
                <a href="<?= base_url('login'); ?>" class="nav-item nav-link">Login</a>
            </div>
                              </ul>
                           </div>
