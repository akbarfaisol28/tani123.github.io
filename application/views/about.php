        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">TentangKami</h1>
                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3">Beranda</a>
            ...
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="d-flex h-100 border border-5 border-primary border-bottom-0 pt-4">
                        <img class="img-fluid mt-auto mx-auto" src="img/desaintoko.png">
                    </div>
                </div>
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        <h6 class="text-primary text-uppercase">TOKO PERTANIAN</h6>
                        <h1 class="display-5">RikaTani</h1>
                    </div>
                    <p class="mb-4">menyediakan berbagai jenis pupuk, pestisida, dan alat pertanian grosir/eceran untuk tanaman pangan, hortikultura, serta perkebunan. Tingkatkan kualitas tanaman Anda dengan produk pertanian yang kami tawarkan.</p>
